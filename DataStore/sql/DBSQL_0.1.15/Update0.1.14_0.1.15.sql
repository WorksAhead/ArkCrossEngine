...
alter table UserInfoExtra add column IsWeeklyLoginRewarded boolean not null;
update UserInfoExtra set IsWeeklyLoginRewarded = '0' where Guid > 0;
alter table UserInfoExtra add column WeeklyLoginRewardList char(64) not null; 
update UserInfoExtra set WeeklyLoginRewardList = '' where Guid > 0;
alter table UserInfoExtra add column LastResetWeeklyLoginRewardTime char(24) not null; 
update UserInfoExtra set LastResetWeeklyLoginRewardTime = '1984/1/1 0:00:00' where Guid > 0;
