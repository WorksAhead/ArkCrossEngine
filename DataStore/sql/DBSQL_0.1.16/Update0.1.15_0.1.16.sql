...
use dsnode;
# 修改数据库版本号
call SetDSNodeVersion('0.1.16');

alter table UserInfo add column X bigint not null;
update UserInfo set X = '0' where Guid > 0;
alter table UserInfo add column Z bigint not null;
update UserInfo set Z = '0' where Guid > 0;