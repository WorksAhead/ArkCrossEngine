...
internal sealed class UnknownDataMessage : ApplicationException
{
    internal UnknownDataMessage ( uint id )
      : base("unknown data message id: " + id)
    {
    }

    internal UnknownDataMessage ( IMessage data_msg )
      : base("unknown data message: " + data_msg.GetType().Name)
    {
    }
}
