...
namespace DashFire
{
    internal class MoveDirController : AbstractController<MoveDirController>
    {
        ...
        internal void Init(SceneContextInfo context, int id, int objId, float moveDir)
        {
            ...
            //LogSystem.Debug("MoveDirController {0}, obj:{1}, moveDir:{2} deltaDir:{3} totalTime:{4} isTerminated:{5}", id, objId, moveDir, m_DeltaDir, m_TotalTime, m_IsTerminated);
        }
