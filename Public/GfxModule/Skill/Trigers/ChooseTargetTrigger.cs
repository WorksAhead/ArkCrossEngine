...
namespace GfxModule.Skill.Trigers
{
    ...
    public class ChooseTargetTrigger : AbstractSkillTriger
    {
        public override ISkillTriger Clone()
        {
            ...
            copy.m_NeedCollider = m_NeedCollider;
            return copy;
        }
        ...
        protected override void Load(ScriptableData.CallData callData)
        {
            ...
            if (num >= 10)
            {
                ...
                {
                    m_Relation = CharacterRelation.RELATION_FRIEND;
                }
                else if (relation_str == "owner")
                {
                    m_Relation = CharacterRelation.RELATION_OWNER;
                }
                else if (relation_str == "sons")
                {
                    m_Relation = CharacterRelation.RELATION_FITSIGNSONS;
                }
                else
                {
                    m_Relation = CharacterRelation.RELATION_ENEMY;
                }
            }
        }
        ...
        private CharacterRelation m_Relation = CharacterRelation.RELATION_ENEMY;
