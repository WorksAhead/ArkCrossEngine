namespace ArkCrossEngine
{
    ...
    public interface IGameLogicNotification
    {
        ...
        void OnGfxBreakSkill(int id, SkillCategory category);
        ...
        void OnGfxSummonNpc(int owner_id, int owner_skill_id, int npc_type_id, string modelPrefab, int skillid,
                            int ailogicid, bool followsummonerdead, float x, float y, float z, string aiparamstr,
                            int signforskill, bool isSimulate);
