...
namespace ArkCrossEngine
{
    ...
    public class AiData_Npc_BossXiLie : AiData_PveNpc_General
    {
        ...
        public int RangeSkill
        {
            get
            {
                int index = CrossEngineHelper.Random.Next(m_RangeSkills.Length);
        ...
        public int MeeleSkill
        {
            get
            {
                int index = CrossEngineHelper.Random.Next(m_MeeleSkills.Length);
        ...
        public int[] MeeleCombo
        {
            get
            {
                int index = CrossEngineHelper.Random.Next(2);
                if (index > 0)
                {
                    return m_MeeleCombo;
                }
    ...
    public class AiData_Npc_BossDevilWarrior : AiData_PveNpc_General
    {
        ...
        public int MeeleSkill
        {
            get
            {
                int index = CrossEngineHelper.Random.Next(10);
                if (index < 7)
                {
                    return m_MeeleSkill;
                }
                ...
                {
                    index = CrossEngineHelper.Random.Next(m_MeelePlus.Length);
    ...
    public class AiData_Npc_BossHulun : AiData_PveNpc_General
    {
        ...
        public int[] m_StageOneSkillCombo
        {
            get
            {
                ...
                result[0] = m_StageOneFirst[CrossEngineHelper.Random.Next(m_StageOneFirst.Length)];
                result[1] = m_StageOneSecond[CrossEngineHelper.Random.Next(m_StageOneSecond.Length)];
                result[2] = m_StageOneThird[CrossEngineHelper.Random.Next(m_StageOneThird.Length)];
                return result;
            }
        }
        public int[] m_StageTwoSkillCombo
        {
            ...
            {
                int[] result = new int[3];
                result[0] = m_StageTwoFirst[CrossEngineHelper.Random.Next(m_StageTwoFirst.Length)];
                result[1] = m_StageTwoSecond[CrossEngineHelper.Random.Next(m_StageTwoSecond.Length)];
                result[2] = m_StageTwoThird[CrossEngineHelper.Random.Next(m_StageTwoThird.Length)];
                return result;
            }
        }
        public int[] m_StageThreeSkillCombo
        {
            get
            {
                ...
                result[0] = m_StageThree[CrossEngineHelper.Random.Next(m_StageThree.Length)];
                return result;
            }
        }
        public int CurStage
    ...
    public class AiData_Npc_ActionDrive : AiData_PveNpc_General
    {
        ...
        public List<AiActionInfo> MaxControlEventPlusActions
        {
            get { return m_MaxControlEventPlusActions; }
            set { m_MaxControlEventPlusActions = value; }
        }
        public List<AiActionInfo> GetUpEventActions
        {
            get { return m_GetUpEventActions; }
            set { m_GetUpEventActions = value; }
        }
        public AiActionInfo ActiveAction
        {
        ...
        public int LastGfxState
        {
            get { return m_LastGfxState; }
            set { m_LastGfxState = value; }
        }
        ...
        private List<AiActionInfo> m_GetUpEventActions = new List<AiActionInfo>();
        private List<AiActionInfo> m_MaxControlEventPlusActions = new List<AiActionInfo>();
