...
namespace ArkCrossEngine
{
    ...
    public class NpcInfo : CharacterInfo
    {
        ...
        public int AppendAttrId
        {
            get { return m_AppendAttrId; }
            set { m_AppendAttrId = value; }
        }
        public int DeadSkillId
        {
            get { return m_DeadSkillId; }
        }
        public List<string> TauntSound
        {
        ...
        {
            if ((int)NpcTypeEnum.BigBoss == m_NpcType || (int)NpcTypeEnum.LittleBoss == m_NpcType || (int)NpcTypeEnum.Normal == m_NpcType || (int)NpcTypeEnum.Partner == m_NpcType)
            {
                return true;
            }
            return false;
        ...
        private List<string> m_TauntSound = new List<string>();
        private int m_SignForSkill = 0;
        private int m_AppendAttrId = 0;
    }
}
