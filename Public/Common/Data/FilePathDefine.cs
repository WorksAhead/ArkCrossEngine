namespace ArkCrossEngine
{
    internal class FilePathDefine
    {
        ...
        public const string C_ItemAttributeConfig = @"Public/ItemAttributeConfig.txt";
        public const string C_ItemLevelupConfig = @"Public/ItemLevelupConfig.txt";
        public const string C_ItemCompoundConfig = @"Public/ItemCompoundConfig.txt";
        public const string C_XSoulLevelConfig = @"Public/XSoulLevelConfig.txt";
        public const string C_EquipmentConfig = @"Public/EquipmentConfig.txt";
        //兑换物品
        public const string C_ExchangeGoodsConfig = @"Public/ExchangeShop.txt";
        // AI
        public const string C_AiActionConfig = @"Public/AI/AIActionConfig.txt";
        public const string C_AiConfig = @"Public/AI/AIConfig.txt";
        public const string C_AiSkillComboList = @"Public/AI/AISkillComboList.txt";
        // 技能系统配置
        ...
        public const string C_LegacyComplexAttrConifg = @"Public/LegacyComplexAttrConfig.txt";
        ...
        public const string C_GowRankConfig = @"Public/Gow/GowRank.txt";
        ...
        // 伙伴
        public const string C_PartnerConfig = @"Public/Partner/PartnerConfig.txt";
        public const string C_PartnerLevelUpConfig = @"Public/Partner/PartnerLevelUpConfig.txt";
        public const string C_PartnerStageUpConfig = @"Public/Partner/PartnerStageUpConfig.txt";

        public const string C_VipConfig = @"Public/VipConfig.txt";
        public const string C_VersionConfig = @"Public/VersionConfig.txt";

        public const string C_MpveMonsterConfig = @"Public/MpveMonsterConfig.txt";
        public const string C_AttemptTollgateConfig = @"Public/AttemptTollgateConfig.txt";
        public const string C_MpveTimeConfig = @"Public/MpveTimeConfig.txt";
        // 活动
        public const string C_WeeklyLoginConfig = @"Public/Activity/WeeklyLoginConfig.txt";
        public const string C_SignInRewardConfig = @"Public/Activity/SignInRewardConfig.txt";
        public const string C_MonthCardConfig = @"Public/Activity/MonthCardConfig.txt";
        public const string C_GiftConfig = @"Public/Activity/GiftConfig.txt";
        public const string C_OnlineDurationConfig = @"Public/Activity/OnlineDurationReward.txt";
        public const string C_LevelLock = @"Public/LevelLock.txt";
        ...
        public const string C_LoadingChange = @"Client/LoadingChange.txt";
        public const string C_DialogPath = @"Client/Dialog/";
        public const string C_DialogConfig = @"Client/Dialog/StoryDlgConfig.txt";
        public const string C_ClickNpc = @"Client/ClickNpcConfig.txt";
        ...
        public const string C_ScrollMessageConfig = @"Client/ScrollMessage.txt";
        public const string C_NotificationConfig = @"Client/NotificationConfig.txt";
        public const string C_CameraConfig = @"Client/CameraConfig.txt";
        public const string C_HitSoundConfig = @"Client/HitSoundConfig.txt";
        public const string C_MainCityConfig = @"Client/MainCityConfig.txt";
        ...
        public const string C_ArenaBaseConfig = @"Public/Arena/ArenaBaseConfig.txt";
        public const string C_ArenaPrizeConfig = @"Public/Arena/ArenaPrizeConfig.txt";
        public const string C_ArenaRobotConfig = @"Server/Arena/ArenaRobotConfig.txt";
        public const string C_ArenaMatchRuleConfig = @"Server/Arena/MatchRuleConfig.txt";
        public const string C_ArenaBuyFightCountConfig = @"Public/Arena/ArenaBuyFightCountConfig.txt";
        public const string C_PaymentRebateConfig = @"Server/Activity/PaymentRebateConfig.txt";
    }
    ...
    public class FilePathDefine_Server
    {
        ...
        public const string C_LegacyComplexAttrConifg = C_RootPath + FilePathDefine.C_LegacyComplexAttrConifg;
        // AI
        public const string C_AiActionConfig = C_RootPath + FilePathDefine.C_AiActionConfig;
        public const string C_AiConfig = C_RootPath + FilePathDefine.C_AiConfig;
        public const string C_AiSkillComboListConfig = C_RootPath + FilePathDefine.C_AiSkillComboList;
        // 任务
        public const string C_MissionConfig = C_RootPath + FilePathDefine.C_MissionConfig;
        // 伙伴
        public const string C_PartnerConfig = C_RootPath + FilePathDefine.C_PartnerConfig;
        public const string C_PartnerLevelUpConfig = C_RootPath + FilePathDefine.C_PartnerLevelUpConfig;
        public const string C_PartnerStageUpConfig = C_RootPath + FilePathDefine.C_PartnerStageUpConfig;
        // 物品装备
        public const string C_ItemConfig = C_RootPath + FilePathDefine.C_ItemConfig;
        public const string C_ItemAttributeConfig = C_RootPath + FilePathDefine.C_ItemAttributeConfig;
        public const string C_ItemLevelupConfig = C_RootPath + FilePathDefine.C_ItemLevelupConfig;
        public const string C_ItemCompoundConfig = C_RootPath + FilePathDefine.C_ItemCompoundConfig;
        public const string C_XSoulLevelConfig = C_RootPath + FilePathDefine.C_XSoulLevelConfig;
        public const string C_EquipmentConfig = C_RootPath + FilePathDefine.C_EquipmentConfig;
        public const string C_ExchangeShopConfig = C_RootPath + FilePathDefine.C_ExchangeGoodsConfig;
        ...
        public const string C_MpveMonsterConfig = C_RootPath + FilePathDefine.C_MpveMonsterConfig;
        public const string C_AttemptTollgateConfig = C_RootPath + FilePathDefine.C_AttemptTollgateConfig;
        public const string C_MpveTimeConfig = C_RootPath + FilePathDefine.C_MpveTimeConfig;
        // 战神赛
        ...
        public const string C_GowRankConfig = C_RootPath + FilePathDefine.C_GowRankConfig;
        public const string C_GowFormulaConfig = C_RootPath + FilePathDefine.C_GowFormulaConfig;
        // 活动
        public const string C_WeeklyLoginConfig = C_RootPath + FilePathDefine.C_WeeklyLoginConfig;
        public const string C_SignInRewardConfig = C_RootPath + FilePathDefine.C_SignInRewardConfig;
        public const string C_MonthCardConfig = C_RootPath + FilePathDefine.C_MonthCardConfig;
        public const string C_GiftConfig = C_RootPath + FilePathDefine.C_GiftConfig;
        public const string C_OnlineDurationRewardConfig = C_RootPath + FilePathDefine.C_OnlineDurationConfig;
        public const string C_PaymentRebateConfig = C_RootPath + FilePathDefine.C_PaymentRebateConfig;
        // 解锁相关
        public const string C_LevelLock = C_RootPath + FilePathDefine.C_LevelLock;
        // GM
        ...
        public const string C_ArenaBaseConfig = C_RootPath + FilePathDefine.C_ArenaBaseConfig;
        public const string C_ArenaPrizeConfig = C_RootPath + FilePathDefine.C_ArenaPrizeConfig;
        public const string C_ArenaRobotConfig = C_RootPath + FilePathDefine.C_ArenaRobotConfig;
        public const string C_ArenaMatchRuleConfig = C_RootPath + FilePathDefine.C_ArenaMatchRuleConfig;
        public const string C_ArenaBuyFightCountConfig = C_RootPath + FilePathDefine.C_ArenaBuyFightCountConfig;
    }
    public class FilePathDefine_Client
    {
        ...
        public const string C_AiActionConfig = C_RootPath + FilePathDefine.C_AiActionConfig;
        public const string C_AiConfig = C_RootPath + FilePathDefine.C_AiConfig;
        public const string C_AiSkillComboList = C_RootPath + FilePathDefine.C_AiSkillComboList;
        //物品装备
        public const string C_ItemConfig = C_RootPath + FilePathDefine.C_ItemConfig;
        public const string C_ItemAttributeConfig = C_RootPath + FilePathDefine.C_ItemAttributeConfig;
        public const string C_ItemLevelupConfig = C_RootPath + FilePathDefine.C_ItemLevelupConfig;
        ...
        public const string C_LoadingChange = C_RootPath + FilePathDefine.C_LoadingChange;
        public const string C_LevelLock = C_RootPath + FilePathDefine.C_LevelLock;
        ...
        public const string C_ClickNpc = C_RootPath + FilePathDefine.C_ClickNpc;
        public const string C_MainCityConfig = C_RootPath + FilePathDefine.C_MainCityConfig;
        //服务器列表配置
        ...
        public const string C_ScrollMessageConfig = C_RootPath + FilePathDefine.C_ScrollMessageConfig;
        public const string C_NotificationConfig = C_RootPath + FilePathDefine.C_NotificationConfig;
        ...
        public const string C_ArenaPrizeConfig = C_RootPath + FilePathDefine.C_ArenaPrizeConfig;
        public const string C_ArenaBuyFightCountConfig = C_RootPath + FilePathDefine.C_ArenaBuyFightCountConfig;
        public const string C_CameraConfig = C_RootPath + FilePathDefine.C_CameraConfig;
        public const string C_HitSoundConfig = C_RootPath + FilePathDefine.C_HitSoundConfig;
    }
}
