namespace ArkCrossEngine
{
    internal sealed class ImpactViewManager
    {
        internal void Init()
        {
            ...
            ImpactSystem.EventStopAllImpact += this.OnStopAllImpact;
            ...
            AbstractImpactLogic.EventRefreshSkill += this.OnRefreshSkill;
        ...
        private void OnImpactScreenTip(CharacterInfo target, string tip)
        {
            if (null != target)
            {
                Vector3 pos = target.GetMovementStateInfo().GetPosition3D();
                pos.Y += 2.0f;
        ...
        private void OnRefreshSkill(CharacterInfo entity)
        {
            GfxSystem.PublishGfxEvent("ge_cast_skill_cd", "ui", "SkillA", 0);
            GfxSystem.PublishGfxEvent("ge_cast_skill_cd", "ui", "SkillB", 0);
            GfxSystem.PublishGfxEvent("ge_cast_skill_cd", "ui", "SkillC", 0);
            GfxSystem.PublishGfxEvent("ge_cast_skill_cd", "ui", "SkillD", 0);
        }
        #endregion
