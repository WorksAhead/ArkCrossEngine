...
namespace LobbyRobot
{
  ...
  internal sealed class Robot
  {
    ...
    internal DashFire.ClientDelayActionProcessor DelayActionQueue
    {
    ...
    internal void RequestUsers(int ct)
    {
      try {
        ...
        DashFireMessage.Msg_CL_RequestUsers protoData = new DashFireMessage.Msg_CL_RequestUsers();
    ...
    internal void UpdatePosition(float x, float z, float dir)
    {
      try {
        ...
        DashFireMessage.Msg_CL_UpdatePosition protoData = new DashFireMessage.Msg_CL_UpdatePosition();
        protoData.m_X = x;
        protoData.m_Z = z;
    ...
    private void HandleQueueingCountResult(JsonMessage msg)
    {
      ...
      DashFireMessage.Msg_LC_QueueingCountResult msgData = msg.m_ProtoData as DashFireMessage.Msg_LC_QueueingCountResult;
      if (null != msgData) {
    ...
    {
      JsonData jsonData = msg.m_JsonData;
      DashFireMessage.Msg_LC_RoleListResult msgData = msg.m_ProtoData as DashFireMessage.Msg_LC_RoleListResult;
      if (null != msgData) {
        int ret = msgData.m_Result;
        if (ret == (int)RoleListResult.Success) {
          //获取玩家角色数据列表 
          int userinfoCount = msgData.m_UserInfoCount;
          List<DashFireMessage.Msg_LC_RoleListResult.UserInfoForMessage> userInfos = msgData.m_UserInfos;
    ...
    private void HandleRoleEnterResult(JsonMessage msg)
    {
      ...
      if (null != protoData) {
        ...
        if (ret == (int)RoleEnterResult.Wait) {
          ...
          DashFireMessage.Msg_CL_RoleEnter sendProtoData = new DashFireMessage.Msg_CL_RoleEnter();
    ...
    {
      DashFireMessage.Msg_LC_MatchResult matchResult = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_MatchResult;
      if (null != matchResult) {
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_MountEquipmentResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_MountEquipmentResult;
      if (null != protoMsg) {
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_UnmountEquipmentResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_UnmountEquipmentResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
        int equipment_pos = protoMsg.m_EquipPos;
        GeneralOperationResult result = (GeneralOperationResult)protoMsg.m_Result;
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_MountSkillResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_MountSkillResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_UnmountSkillResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_UnmountSkillResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
        int preset_index = protoMsg.m_PresetIndex;
        SlotPosition slot_position = (SlotPosition)protoMsg.m_SlotPos;
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_UpgradeSkillResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_UpgradeSkillResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
        int preset_index = protoMsg.m_PresetIndex;
        int skill_id = protoMsg.m_SkillID;
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_UnlockSkillResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_UnlockSkillResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
        int preset_index = protoMsg.m_PresetIndex;
        int skill_id = protoMsg.m_SkillID;
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_SwapSkillResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_SwapSkillResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
        int preset_index = protoMsg.m_PresetIndex;
        int skill_id = protoMsg.m_SkillID;
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_LiftSkillResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_LiftSkillResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
        int skill_id = protoMsg.m_SkillID;
        GeneralOperationResult result = (GeneralOperationResult)protoMsg.m_Result;
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_UpgradeItemResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_UpgradeItemResult;
      if (null != protoMsg) {
        ulong guid = jsonData.GetUlong("m_Guid");
    ...
    private void HandleSyncMpveBattleResult(JsonMessage lobbyMsg)
    {
      ...
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_SyncMpveBattleResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_SyncMpveBattleResult;
      if (null != protoMsg) {
        if (protoMsg.m_Result == 0) {//多人pve只处理成功情形，奖励在StagClearResult里处理。失败处理不走大厅流程。
          JsonMessage stageClearMsg = new JsonMessage(JsonMessageID.StageClear);
          stageClearMsg.m_JsonData.Set("m_Guid", LobbyNetworkSystem.Guid);
          DashFireMessage.Msg_CL_StageClear protoData = new DashFireMessage.Msg_CL_StageClear();
    ...
    private void HandleSyncGowBattleResult(JsonMessage lobbyMsg)
    {
      //m_Result: 0--win 1--lost 2--unfinish
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_SyncGowBattleResult protoMsg = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_SyncGowBattleResult;
      if (null != protoMsg) {
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_RequestExpeditionResult msgData = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_RequestExpeditionResult;
      if (null != msgData) {
    ...
    {
      JsonData jsonData = lobbyMsg.m_JsonData;
      DashFireMessage.Msg_LC_FinishExpeditionResult msgData = lobbyMsg.m_ProtoData as DashFireMessage.Msg_LC_FinishExpeditionResult;
      if (null != msgData) {
        int result = msgData.m_Result;
